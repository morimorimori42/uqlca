...
db1_do1_probabilistic_results = do_probabilistic_lca_calculator.calculate_do_probabilistic_impact(n_samples=1000)
aggregated_db1_do1_results = do_probabilistic_lca_calculator.collect_aggregated_data(db1_do1_probabilistic_results)
full_db1_do1_results = do_probabilistic_lca_calculator.collect_overall_aggregated_data(db1_do1_probabilistic_results)
...
db2_do1_probabilistic_results = do_probabilistic_lca_calculator.calculate_do_probabilistic_impact(n_samples=1000)
aggregated_db2_do1_results = do_probabilistic_lca_calculator.collect_aggregated_data(db2_do1_probabilistic_results)
full_db2_do1_results = do_probabilistic_lca_calculator.collect_overall_aggregated_data(db2_do1_probabilistic_results)
...
db3_do1_probabilistic_results = do_probabilistic_lca_calculator.calculate_do_probabilistic_impact(n_samples=1000)
aggregated_db3_do1_results = do_probabilistic_lca_calculator.collect_aggregated_data(db3_do1_probabilistic_results)
full_db3_do1_results = do_probabilistic_lca_calculator.collect_overall_aggregated_data(db3_do1_probabilistic_results)

full_results = [full_db1_do1_results, full_db2_do1_results, full_db3_do1_results]
